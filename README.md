...
3. **Domain** — built for `collingwoodstairlift.ca`. If that changes, update each page's `<link rel="canonical">` and the schema `url`/`image` fields.
